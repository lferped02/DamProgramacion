...
public class GestionaPlaneta {
    public static void main(String[] args) {
        ...
        sistemaSolar[numerosAstros++] = marte;
        sistemaSolar[numerosAstros++] = fobos;
        sistemaSolar[numerosAstros++] = deimos;

        System.out.println("=== PRUEBA DE TOSTRING() ===");
        for (int i = 0; i < numerosAstros; i++) {
            System.out.println(sistemaSolar[i].toString());
        }

        for (int i = 0; i < numerosAstros; i++) {
            muestraInformacion(sistemaSolar[i]);
            System.out.println("-----------------------");
        }
