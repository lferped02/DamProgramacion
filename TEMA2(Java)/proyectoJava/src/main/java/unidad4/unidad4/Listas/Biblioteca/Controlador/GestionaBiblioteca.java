...
public class GestionaBiblioteca {
    public static void main(String[] args) {
        ...
        String autor1 ="Cervantes";
        String usuario1 = "Lili";
        ...
        do {
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 2:
                        Libro libroPrestar = biblioteca.buscarLibro(titulo1, autor1);
                        if (libroPrestar != null) {
                            biblioteca.getRepositorioPrestamo().agregarPrestamo(libroPrestar, usuario1);
                        } else {
                    ...
                    case 3:
                        Libro libroDevolver = biblioteca.buscarLibro(titulo1, autor1);
                        if (libroDevolver != null) {
                            biblioteca.getRepositorioPrestamo().devolverLibro(libroDevolver);
                        } else {
                            System.out.println("Libro no encontrado.");
                        }
                        break;
                    ...
                    case 5:
                        System.out.print("Título: ");
                        String tDetalle = scanner.nextLine();
                        System.out.print("Autor: ");
                        String aDetalle = scanner.nextLine();
                        biblioteca.mostrarDetalle(tDetalle, aDetalle);
                        break;

                    case 6:
                        System.out.print("Título: ");
                        String tBuscarLibro = scanner.nextLine();
                        System.out.print("Autor: ");
                        String aBuscarLibro = scanner.nextLine();

                        Libro l = biblioteca.buscarLibro(tBuscarLibro, aBuscarLibro);
                        if (l != null) {
                            l.mostrarInfo();
                        } else {
                    ...
                    case 7:
                        biblioteca.getRepositorioPrestamo().mostrarPrestamos();
                        break;
                    ...
                    case 8:
                        ...
                        biblioteca.getRepositorioPrestamo().buscarPrestamosPorLibro(tBuscar, aBuscar);
                        break;
