...
public class Animales {
    ...
    public Animales(int id, String nombre, String especie, int edad, ClasificacionComida tipoComida, LocalDate fechaNacimiento, double peso, Medio medio, ClasificacionGestacion tipoGestacion) {
        this.id = id;
        this.nombre = nombre;
